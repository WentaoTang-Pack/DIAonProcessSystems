...
CovMatrix = Sigma_hatxhatx(3:4,3:4);
...
t = linspace(0,2*pi,10); %Our ellipse will have 100 points on it
...
plot3(E3(1,:), E3(2,:), 1e-3+zeros(1,size(E3,2)),'Color',[1 0.5 0],'LineWidth',2);
...
zlabel('Probability Density Function', 'FontSize', 14);
plot3(ones(size(Y))*X(1), Y, Z_y,'-r','LineWidth',2);
xlabel('$C_{A1}(kmol/m^3)$', 'Interpreter', 'latex', 'FontSize', 20)
ylabel('$T_1(K)$', 'Interpreter', 'latex', 'FontSize', 20)
