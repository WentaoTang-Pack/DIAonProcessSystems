...
for i = 1:size(v_list,2)
    ...
    [~,D1_k3(i),D2_k3(i)] = f_obj_ksparse(Sigma_xixi,Sigma_yy,Sigma_aa_temp,lambda,A,B,K,L,C,Vd,Vn);
    [P_d_k3(i),P_f_k3(i)] = f_AttackDetection(Sigma_yy,Sigma_aa_temp);
end   
plot(D2_k3,-D1_k3,'-^', 'LineWidth', 1.5, 'MarkerSize', 6, 'Color', [1 0.5 0]), hold on;
save('D1_k3','D1_k3')
save('D2_k3','D2_k3')
save('P_d_k3','P_d_k3')
save('P_f_k3','P_f_k3')
